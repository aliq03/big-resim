...
{
$("body").append('<div id="dreamland" style="position: fixed;padding: 0px;display: none;top:0px;left:0px;z-index: 9;"><div id="dreambackground" style="position: fixed;height: 100%;z-index:1000;width: 100%;    background-color: #fff;"></div><div id="tool"><svg height="50" width="50" style="cursor:pointer;float: right;z-index: 10005;position: fixed;"><rect x="0" y="0" height="50" width="50" fill="white" style="display: none;" /><path d="M 5 5 L 45 45" stroke="black" stroke-width="1" /><path d="M 45 5 L 5 45" stroke="black" stroke-width="1" /></svg><span style="width: 120px;background-color: #555;color: #fff;text-align: center;padding: 5px 0;border-radius: 6px;position: absolute;z-index: 100000;left:50px;top:10px;display:none;">kapat</span></div><div id="dreamcontent" style="text-align: center;height: 95%;width: 95%;z-index:10001;padding: 40px;position: fixed;"><img src="#" style="transform: rotate(0deg);max-height: 90%;max-width: 90%;width: auto;height: auto;position: relative;" alt="Unable to load image"></img></div><h1 id="sub" style="font-family: sans-serif;font-weight: 200;display: none;z-index: 10009;text-align:center;position: fixed;text-shadow: 2px 2px 7px black;color: white;bottom: 0px;width: 100%;text-align: center;"></h1><span style="position: fixed; bottom: 20px; right: 20px; padding: 20px; color: white; background-color: rgba(0,0,0,0.95); border: 1px solid rgba(0,0,0,0.95); cursor: pointer; z-index: 100000; font-size: 19px; font-family: roboto;">döndür</span>');
